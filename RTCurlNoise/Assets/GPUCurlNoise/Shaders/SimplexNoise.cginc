// Porting webgl-noise to HLSL
// Ported by hiroakioishi
//
...
float simplexNoise(float2 v){
	...
	// The ring size 17*17 = 289 is close to multiple of 41 ( 41 * 7 = 287 )
...
float simplexNoise(float4 v) {
	...
	float4 j1 = permute( permute( permute( permute (
	  i.w + float4(i1.w, i2.w, i3.w, 1.0 )) + i.z + float4(i1.z, i2.z, i3.z, 1.0 ))
